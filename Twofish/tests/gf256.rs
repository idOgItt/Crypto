...
mod tests {
    ...
    fn test_gf_mul_known_values() {
        ...
        let test_cases = [
            (0x01, 0x01, 0x01),
            (0x02, 0x02, 0x04),
            (0x57, 0x83, 0x46), // ← Twofish
            (0x57, 0x13, 0x2D), // ← Twofish
            (0x01, 0xFF, 0xFF),
            (0xFF, 0x02, 0x97), // ← Twofish
            (0xFF, 0xFF, 0x90), // ← Twofish
        ];
    ...
    fn test_gf_pow_known_values() {
        ...
        let test_cases = [
            ...
            (0x02, 3, 0x08),
            (0x02, 4, 0x10),
            (0x02, 8, 0x69), // 2^8 = 0x69
            (0x03, 2, 0x05), // 3^2 = 5
            (0x05, 3, 0x55), // 5^3 = 0x55
            (0xFF, 2, 0x90), // 255^2 = 0x90
            (0xFF, 3, 0x66), // 255^3 = 0x66
        ];
