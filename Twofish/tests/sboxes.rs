...
mod tests {
    ...
    fn test_q0_values() {
        ...
        // Проверка случайных значений по индексу (теперь реальные из Q0)
        assert_eq!(q0(42), 0x3d);
        assert_eq!(q0(100), 0xe9);
        assert_eq!(q0(200), 0xb8);
    }
    ...
    fn test_q1_values() {
        ...
        // Проверка случайных значений по индексу (теперь реальные из Q1)
        assert_eq!(q1(42), 0xb1);
    }
